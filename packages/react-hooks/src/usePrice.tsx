...
const insertPrice = (arr: DerivedPrice[], target: DerivedPrice): DerivedPrice[] => {
  const index = arr.findIndex((item): boolean => tokenEq(item.token, target.token));
